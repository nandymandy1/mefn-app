...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__service_auth_service__ = __webpack_require__("./src/app/service/auth.service.ts");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_13__service_validate_service__["a" /* ValidateService */], __WEBPACK_IMPORTED_MODULE_14__service_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_15__guards_auth_guard__["a" /* AuthGuard */]],
...
module.exports = "<h2 class=\"page-header\">Dashboard</h2>\n<p>Welcome to your Dashboard build with MEAN Stack...</p>\n"
...
module.exports = "<div class=\"jumbotron mb-0\">\n  <h3 class=\"display-3\">Mean Auth App</h3>\n  <p class=\"lead\">Welcome to our custom MEAN Auth Appp built from scratch.</p>\n  <hr class=\"my-4\">\n  <p>It uses utility classes for typography and spacing to space content out within the larger container.</p>\n  <div class=\"center\">\n    <p class=\"lead\" *ngIf=\"!auth.loggedIn()\">\n      <a class=\"btn btn-primary btn-lg\" [routerLink]=\"['/register']\">Get Started</a>\n      <a class=\"btn btn-info btn-lg\" [routerLink]=\"['/login']\">Login</a>\n    </p>\n    <p class=\"lead\" *ngIf=\"auth.loggedIn()\">\n        <a class=\"btn btn-primary btn-lg\" [routerLink]=\"['/profile']\">Profile</a>\n      </p>\n  </div>\n</div>\n<div class=\"row\">\n  <div class=\"col-md-3 col-sm-6 col-xs-12\">\n    <div class=\"card text-white bg-info mb-3\" style=\"max-width: 20rem;\">\n      <div class=\"card-header\">Mongo DB</div>\n      <div class=\"card-body\">\n        <h4 class=\"card-title\">Info card title</h4>\n        <p class=\"card-text\">Some quick example text to build on the card title and make up the bulk of the card's content.</p>\n      </div>\n    </div>\n  </div>\n  <div class=\"col-md-3 col-sm-6 col-xs-12\">\n      <div class=\"card text-white bg-success mb-3\" style=\"max-width: 20rem;\">\n          <div class=\"card-header\">Express.js</div>\n          <div class=\"card-body\">\n            <h4 class=\"card-title\">Info card title</h4>\n            <p class=\"card-text\">Some quick example text to build on the card title and make up the bulk of the card's content.</p>\n          </div>\n        </div>\n  </div>\n  <div class=\"col-md-3 col-sm-6 col-xs-12\">\n      <div class=\"card text-white bg-warning mb-3\" style=\"max-width: 20rem;\">\n          <div class=\"card-header\">Angular</div>\n          <div class=\"card-body\">\n            <h4 class=\"card-title\">Info card title</h4>\n            <p class=\"card-text\">Some quick example text to build on the card title and make up the bulk of the card's content.</p>\n          </div>\n        </div>\n  </div>\n  <div class=\"col-md-3 col-sm-6 col-xs-12\">\n      <div class=\"card text-white bg-danger mb-3\" style=\"max-width: 20rem;\">\n          <div class=\"card-header\">Node.js</div>\n          <div class=\"card-body\">\n            <h4 class=\"card-title\">Info card title</h4>\n            <p class=\"card-text\">Some quick example text to build on the card title and make up the bulk of the card's content.</p>\n          </div>\n        </div>\n  </div>\n</div>"
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(auth, fMsgSer, router) {
        this.auth = auth;
        this.fMsgSer = fMsgSer;
        this.router = router;
    }
    ...
    LoginComponent.prototype.onSubmitLogin = function () {
        ...
        this.auth.authenticateUser(user)
            ...
            if (data.success) {
                ...
                _this.fMsgSer.show("You are logged in Successfully", { cssClass: 'alert alert-success', timeout: 5000 });
                _this.router.navigate(['dashboard']);
            }
            else {
                _this.fMsgSer.show(data.msg, { cssClass: 'alert alert-danger', timeout: 5000 });
...
var NavbarComponent = /** @class */ (function () {
    function NavbarComponent(auth, fMsgSer, router) {
        this.auth = auth;
        this.fMsgSer = fMsgSer;
        this.router = router;
    }
...
module.exports = "<div class=\"card text-white bg-info mb-3\" *ngIf=\"user\">\n  <div class=\"card-header\">{{ user.name }}</div>\n  <div class=\"card-body\">\n    <h4 class=\"card-title\">Username: {{ user.username }}</h4>\n    <p class=\"card-text\">Email: {{ user.email }}</p>\n  </div>\n</div>"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__service_validate_service__ = __webpack_require__("./src/app/service/validate.service.ts");
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(validateService, fMsgSer, auth, router) {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        if (this.c_password === this.password) {
            ...
            this.auth.registerUser(user).subscribe(function (data) {
                if (data.success) {
                    _this.fMsgSer.show("User Registration Successful", { cssClass: 'alert alert-success', timeout: 5000 });
                    _this.router.navigate(['/login']);
                }
                else {
                    _this.fMsgSer.show("Something went Worng User Registration Failed", { cssClass: 'alert alert-danger', timeout: 5000 });
                    _this.router.navigate(['/login']);
                }
            });
        }
    ...
    RegisterComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__service_validate_service__["a" /* ValidateService */],
